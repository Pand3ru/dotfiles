...
static const char *altbarcmd        = "$HOME/.config/polybar/launch.sh --forest"; /* Alternate bar launch command */
...
static const char *dmenucmd[] = { "/home/user/.config/polybar/forest/scripts/launcher.sh", NULL };
static const char *termcmd[]  = { "kitty", NULL };
static const char *firecmd[]  = { "firefox", NULL };
static const char *excmd[]    = { "dolphin", NULL };
